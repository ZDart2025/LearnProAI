...
import 'package:learnpro/feature/profile/presentation/pages/account/presentation/pages/delete_account_page.dart';
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.delete,
                  color: Colors.red, size: 24), // Delete bin icon
